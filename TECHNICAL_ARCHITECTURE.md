...
| **Three.js / WebGL** | No 3D is needed. Any suggestion to add a "3D fabric viewer" should be resisted — it would add 200KB+ to the bundle, require fallbacks, and distract from the photography. |
