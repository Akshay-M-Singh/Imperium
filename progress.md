...
- [ ] Silk Hero resting-frame poster export (`?silkFreeze=<t>` capture per spec §4 Phase 2 testing) to replace the pre-existing flat SVG placeholders as the reduced-motion/no-WebGL fallback image
